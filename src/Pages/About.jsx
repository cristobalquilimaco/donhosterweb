...
const About = () => {
  return (
    <div className="about__box">
      ...
      <h1 className="section-title">THE COMPANY</h1>
      <p className="">About DonHoster C.A,</p>
      <section className="about__txt">
        It is a company focused on the Internet technology industry. Operating
        ...
        market with the highest quality standards and at the best price. Founded
        on December, 2017, it has grown from a Miami Hosting company, an
        ...
        data protection service to our customers. Mission • Offer the best
        services and the most competitive rates to be a leader in the
        international community. • Maintain the necessary operational structure
        and minimize our costs to guarantee our customers better rates, quality
        and the best service. . All this oriented to the search of appropriate
        technologies that guarantee our competitiveness to establish long-term
        working relationships with our clients. Objective Being a company of
        excellence, to provide customers with the best service in systems,
        servers, web designs, networks and computers in general, providing
        security and guarantee of our work. Values that do not characterize:
        Ethics, Responsibility, Commitment and Respect for our clients.
        DonHoster C.A. offers its customers innovative products and services
