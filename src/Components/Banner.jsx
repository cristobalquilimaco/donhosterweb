...
const Banner = () => {
  return (
    <div className="container container__banner1">
      <img className="img__banner__data" src={images.bannerdata} alt="data center" width="100%" height="400" />
      <div className="row align-items-center">
        <div className="col-xl-6 col-lg-6 wow fadeInDown" data-wow-delay="0.1s" style={{ visibility: 'visible', animationDelay: '0.1s', animationName: 'fadeInDown' }}>
          ...
          <h1 className="principal_title">Dedicated <span className="text-base">Server</span> &amp; <span className="text-base-2">VPS Hosting</span> in Our Platform
            </h1>
...
Connectivity at 99% uptimice, Integrated DDoS protection
        ...
        <div className="col-xl-6 col-lg-6">
          ...
          <img className="img_banner" src={images.server1} alt="Server in Miami" width="600" height="400" />
          </div>
        </div>
      </div>
    </div>
